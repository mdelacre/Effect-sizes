...
This might also explain why the standardizers of Shieh's $d_s$ and Cohen's $d'_s$ are this time **correlated** with $\bar{X_1}-\bar{X_2}$ (see Figure \ref{fig:pltStdzrHombalLskew}):
