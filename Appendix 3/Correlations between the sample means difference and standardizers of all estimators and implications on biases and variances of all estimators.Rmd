...
```{r pltSDMEANHomunbalsym,fig.cap="$S_j$ as a function of $\\bar{X_j}$ (j=1,2), when samples are extracted from symmetric distributions ($\\gamma_1 = 0$), n1=20 and n2=100",echo=FALSE}
par(mfrow=c(1,2),mar=c(5,5,5,2))
...
This might also explain why the standardizers of Shieh's $d_s$ and Cohen's $d'_s$ are this time **correlated** with $\bar{X_1}-\bar{X_2}$ (see Figure \ref{fig:pltStdzrHomunbalLskew}):  
