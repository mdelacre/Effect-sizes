...
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.1.png")
```

```{r "biased_condB", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.2.png")
```

```{r "biased_condC", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.3.png")
```

```{r "biased_condD", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.4.png")
```

```{r "unbiased_condA", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.5.png")
```

```{r "unbiased_condB", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.6.png")
```

```{r "unbiased_condC", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.7.png")
```

```{r "unbiased_condD", fig.env = "sidewaysfigure",dpi=80,echo=FALSE, fig.cap="",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/mdelacre/Documents/Github projects/Effect-sizes/Supplemental Material 2/Files/Png tables/Table A2.8.png")
```
