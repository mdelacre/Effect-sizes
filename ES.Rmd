...
\begin{equation} 
Shieh's \; d_{s,bias} = 2 \times Cohen's \; d_{s,bias} \;\;\; (\mbox{considering} \; \sigma_1 = \sigma_2 \; \mbox{and} \; n_1 = n_2)
(\#eq:biasCohenshieh)
\end{equation} 
\begin{equation} 
Shieh's \; d_{s,variance} = 4 \times Cohen's \; d_{s,variance} \;\;\;(\mbox{considering}\; \sigma_1 = \sigma_2 \; \mbox{and} \; n_1 = n_2)
(\#eq:varCohenshieh)
\end{equation} 
