...
# Different measures of effect sizes TOUCHER UN MOT SUR L'IMPACR DE LA DIFFERENCE DE MOYENNE.
...
```{r "idHombal",fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of five estimator of standardized mean difference, when variances and sample sizes are equal across groups",fig.width = 15,fig.height=8,out.width="20%",fig.show='hold',fig.align='center'}
...
Figure \ref{fig:idHetbal} shows that when variances are unequal but sample sizes are equal between groups, ...
...
```{r "idHetbal", fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of five estimator of standardized mean difference, when variances are unequal across groups and sample sizes are equal",fig.width = 15,fig.height=8,out.width = '20%',fig.show='hold',fig.align='center'}
...
Figure \ref{fig:idHetrpos} shows that when variances are unequal, and the largest group is associated with largest variance, ...
...
Figure \ref{fig:idHetrneg} shows that when variances are unequal, and the largest group is associated with smallest variance, ...
