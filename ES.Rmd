...
The exact distribution of Welch's *t*-statistic is more complicated than the exact distribution of Student's *t*-statistic, but it follows a *t*-distribution with degrees of freedom and noncentrality parameters that can be approximated as follows, under the assumption of normality [@Welch_1938; @Shieh_2013]:
