...
#When used for *inference*, effect size measures should meet some mathematical properties that will be explained in the next section. In the context of #heteroscedasticity, it does not seem possible to meet these properties without taking the specificity of the design into account [@Shieh_2013]. On the other side, #generality is required for comparative and interpretive purposes [@Cumming_2013].  
