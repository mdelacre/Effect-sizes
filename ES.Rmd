...
SUMMARY GLASS: il y a 2 facteurs "aggravants" quand distribution symétriques, et 3 facteurs "aggravants" quand distributions asymétriques:  
- SD calculé sur base du plus petit n (--> mesure plus variable et biaisée car distributions plus asymétrique)  
- SD négativement corrélé avec la différence de moyenne quand mu1-mu2 > 0 (= choix de SD2 quand asymétrie positive, et de SD1 quand asymétrie négative, vu qu'on calcule m1-m2) OU SD positivement corrélé avec la différence de moyenne quand mu1-mu2 < 0 (= choix de SD1 quand asymétrie positive, et de SD2 quand asymétrie négative, vu qu'on calcule m1-m2).  
- sigma? -> reste à voir!
