...
\begin{equation} 
Shieh's \; \delta_{n_1=n_2}= Shieh's \; \delta \times \frac{(nratio+1) \times \hat{\sigma}_{n_1 \neq n_2}}{2 \times \hat{\sigma}_{n_1=n_2} \times \sqrt{nratio}}
...
\newpage
Table 4.
*Correlation between standardizers ($SD_1$,$SD_2$ and others) and $\bar{X_1}-\bar{X_1}$, when samples are extracted from skewed distributions with unequal variances, as a function of the SD-ratio*
