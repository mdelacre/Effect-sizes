...
|    |      |  |    |
| \tiny$Glass's \; d_s$    | \tiny$\delta_{glass} \times \frac{\sqrt{\frac{n_{c}-1}{2}} \times \Gamma(\frac{n_{c}-2}{2})}{\Gamma(\frac{n_{c}-1}{2})}$  |   \tiny$\delta_{glass} \times \left( \frac{\sqrt{\frac{n_{c}-1}{2}} \times \Gamma(\frac{n_{c}-2}{2})}{\Gamma(\frac{n_{c}-1}{2})}-1 \right)$       |\tiny$\frac{n_{c}-1}{n_c-3} \times \left( \frac{1}{n_c} + \frac{\sigma^2_e}{n_e\sigma^2_c} + \delta^2_{glass}\right) -\delta_{glass}^2 \times \left[\frac{\sqrt{\frac{n_{c}-1}{2}} \times \Gamma(\frac{n_{c}-2}{2})}{\Gamma(\frac{n_{c}-1}{2})}\right]^2$ |     |
|    |      |  |    |
