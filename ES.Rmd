...
| | df|      Expectation    |               Variance                     |
|:-----------|:-------------------:|:-----------------:  | :----------------------------------------------------:| 
| Glass's $d$    |$n_c-1$|\ $\delta_{Glass} \times c_f$  |   $\frac{df}{df-2} \times \left( \frac{1}{n_c} + \frac{\sigma^2_e}{n_e\sigma^2_c}\right) + \delta^2_{Glass} \left( \frac{df}{df-2} - c_f^2 \right)$ |     |
|    |      |  |    |
...
|    |      |  |    |
Table: Expectation, bias and variance of Glass's $d$ and Cohen's $d^*$ and Shieh's $d$ under the assumption that independent residuals are normally distributed.
...
| | df|      Expectation    |               Variance                     |
|:-----------|:-------------------:|:-----------------:  | :----------------------------------------------------:| 
| Glass's $g$    |$n_c-1$|\ $\delta_{glass}$  |   $Var(Glass's \; d) \times \left( \frac{\Gamma\left(\frac{df}{2} \right)}{\sqrt{\frac{df}{2}} \times \Gamma \left( \frac{df-1}{2}\right)}\right)^2$ |
|    |      |  |    |
| Cohen's $g^*$    |$\frac{(n_1-1)(n_2-1)(\sigma^2_1+\sigma^2_2)^2}{(n_2-1)\sigma^4_1+(n_1-1)\sigma^4_2}$|  $\delta^*_{Cohen}$       |$Var(Cohen's \; d^*_s) \times \left( \frac{\Gamma\left(\frac{df}{2} \right)}{\sqrt{\frac{df}{2}} \times \Gamma \left( \frac{df-1}{2}\right)}\right)^2$ |     |
  |    |      |  |    ||
