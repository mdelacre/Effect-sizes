...
```{r "idHetunbal1", fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), total sample (N) equals 150, and $n_1>n_2$",fig.width = 15,fig.height=8,out.width = '20%',fig.show='hold',fig.align='center'}
myimages<-list.files("C:/Users/Marie/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/id_Het_firstlarger/N=150", full.names = TRUE)
knitr::include_graphics(myimages)
```

```{r "idHetunbal2", fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), total sample (N) equals 150, and $n_1<n_2$",fig.width = 15,fig.height=8,out.width = '20%',fig.show='hold',fig.align='center'}
myimages<-list.files("C:/Users/Marie/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/id_Het_firstsmaller/N=150", full.names = TRUE)
knitr::include_graphics(myimages)
```

```{r "idHetunbal3", fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), total sample (N) equals 120, and $n_1>n_2$",fig.width = 15,fig.height=8,out.width = '20%',fig.show='hold',fig.align='center'}
myimages<-list.files("C:/Users/Marie/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/id_Het_firstlarger/N=120", full.names = TRUE)
knitr::include_graphics(myimages)
```

```{r "idHetunbal4", fig.env = "sidewaysfigure",echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), total sample (N) equals 120, and $n_1<n_2$",fig.width = 15,fig.height=8,out.width = '20%',fig.show='hold',fig.align='center'}
myimages<-list.files("C:/Users/Marie/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/id_Het_firstsmaller/N=120", full.names = TRUE)
knitr::include_graphics(myimages)
```
