...
While we focus on the theoretical bias of biased estimators (Cohen's $d_s$, Glass's $d_s$, Shieh's $d_s$ and Cohen's $d'_s$) when the normality assumption is met, it is interesting to notice that our main conclusions seem to generalize to :  
...
The **bias** of Shieh's $d'_s$ is a function of the population effect size ($\delta_{Shieh}$), the total sample size, and the interaction between the sample sizes ratio and the $SD$-ratio $\left(\frac{n_1}{n_2}\times\frac{\sigma_1}{\sigma_2} \right)$:   
