...
```
  ...
  + The larger the total sample size, the lower the variance. It remains true when the sample sizes ratio is constant (see Figure \ref{fig:varshiehhomNsize2}) and when it is not (see Figure \ref{fig:varshiehhomNsize4}).
