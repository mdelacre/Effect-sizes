...
\hypertarget{glasss-bmd-see-table-2}{%
\subsection{\texorpdfstring{Glass's \(\bm{d}\) (see Table 2)}{Glass's \textbackslash bm\{d\} (see Table 2)}}\label{glasss-bmd-see-table-2}}
