...
\hypertarget{cohens-d_s-see-table-2}{%
\subsection{\texorpdfstring{Cohen's \(d'_s\) (see Table 2)}{Cohen's d'\_s (see Table 2)}}\label{cohens-d_s-see-table-2}}
...
\hypertarget{shiehs-d_s-see-table-2}{%
\subsection{\texorpdfstring{Shieh's \(d_s\) (see Table 2)}{Shieh's d\_s (see Table 2)}}\label{shiehs-d_s-see-table-2}}
