...
The variance of Cohen's $\delta'_s$ is a function of the population effect size ($\delta'_{Cohen}$), the total sample size and the interaction between sample sizes ratio and $SD$-ratio:  
