...
```{r varshiehhetunbalNsize4,fig.cap="Variance of Shieh's $d_s$ when variances and sample sizes are unequal across groups, as a function of the total sample size, when adding subjects only in one group (either in the first group; see top plots; or in the second group; see bottom plots), and $\\sigma_1 > \\sigma_2$ (top plots) or $\\sigma_1 < \\sigma_2$ (bottom plots).",echo=FALSE}
par(mfrow=c(2,2))
#plot(Nsize,DF,xlab="N")
plot(Nsize,var,ylab=expression(paste("Var(",d[s],")")),xlab="N")
