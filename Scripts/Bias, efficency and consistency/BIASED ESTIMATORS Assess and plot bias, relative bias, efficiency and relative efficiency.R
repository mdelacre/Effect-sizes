...
plot(1,1,bty="n",xaxt="n",yaxt="n",ylim=c(.62,.67),main="",xlab="",ylab="",pch=19,type="o")
legend("center", 
       legend=c(expression(paste("Cohen's ",g)),expression(paste("Glass's ",g,"(",sigma," =",S[1],")")),expression(paste("Glass's ",g,"(",sigma," =",S[2],")")),expression(paste("Shieh's ",g)),
                expression(paste("Cohen's ",g,"*"))),
       fill=c("black","grey40","grey60","grey80","white"),
       bty="n",horiz=T,cex=2
)
