...
#  colnames(good_mes) <- c("n1","n2","n1/n2","m1-m2","sd1/sd2",paste0(columns_names[,2],columns_names[,1]))
  ...
  #  setwd("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators")
...
setwd("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/")
...
Path <-  "D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators/"
...
for (j in seq_len(length(list.files(Path)))){
  ...
  for (i in seq_len(length(Conditions_id))){ 
    ...
    setwd("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Raw estimators of goodness/")
    #dir.create(names(Conditions_id)[i])

    setwd(paste0("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Raw estimators of goodness/",names(Conditions_id)[i]))
    if(G1==-2.08){
      g1=2.08
    } else {g1=G1}
...
for (j in seq_len(length(list.files(Path)))){
  ...
  setwd(paste0("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Raw estimators of goodness/id_Het_bal/sd-ratio"))
  if(G1==-2.08){
    g1=2.08
  } else {g1=G1}
  png(file=paste0("bias_eff,G1=",g1, " & G2=",G2,";",names(Conditions_id)[i], ".png"),width=1400,height=1700, units = "px", res = 300)  
...
for (j in seq_len(length(list.files(Path)))){
  ...
  for (i in seq_len(length(Conditions_id))){ 
    ...
    setwd("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/")
    #dir.create(names(Conditions_id)[i])
    
    setwd(paste0("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/",names(Conditions_id)[i]))
    if(G1==-2.08){
      g1=2.08
    } else {g1=G1}
    png(file=paste0("bias_eff,G1=",g1, " & G2=",G2,";",names(Conditions_id)[i], ".png"),width=1400,height=1700, units = "px", res = 300)  
...
for (j in seq_len(length(list.files(Path)))){
  ...
  setwd(paste0("D:/Documents/Github_projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Relative estimators of goodness/id_Het_bal/sd-ratio"))
  if(G1==-2.08){
    g1=2.08
  } else {g1=G1}
...
plot_hetr <- function(ratio){for (j in seq_len(length(list.files(Path)))){
  ...
  for (i in seq_len(length(Conditions_id))){ 
    ...
    setwd("D:/Documents/Github_projects/Effect-sizes/Réflexion-extras/interaction_n_sd_shieh&hedges")
