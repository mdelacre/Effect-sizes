...
\begin{equation} 
Shieh's \space ds_{n_1=n_2}= Shieh's \space ds \times \frac{(nratio+1) \times SD_{n_1 \neq n_2}}{2 \times SD_{n_1=n_2} \times \sqrt{nratio}}
...
\(Shieh's \space ds_{n_1=n_2}\) can be compared across two different studies using different sample sizes allocation ratio and could be included in meta-analysis.
...
\addcontentsline{toc}{subsubsection}{Simulation 2: confidence intervals}
