...
\title{Argument to use the Hedges' \(g^*\) with the Welch's \(t\)-test : an investigation of Cohen's \(d\) and related effect size estimators in terms of bias, precision and robustness}
...
\hypersetup{
  pdftitle={Argument to use the Hedges' g\^{}* with the Welch's t-test : an investigation of Cohen's d and related effect size estimators in terms of bias, precision and robustness},
