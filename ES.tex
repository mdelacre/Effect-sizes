...
\emph{Note.} N is the total sample size (n1+n2). Equations to compute expectency, bias and variances of Cohen's ds, Hedge's gs and Glass's ds require the assumptions of normality and equal variances. SHOULD I ALSO MENTION THE LIMIT WHEN N TENDS TO INFINITY IN ORDER TO DEFINE CONSISTENCY?
