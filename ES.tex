...
\hypersetup{
  pdftitle={Arguments to use the Hedges' g\^{}* with the Welch's t-test : an investigation of Cohen's d and related effect size estimators in terms of bias, precision, and robustness.},
...
\item
  We previously explained why we need to consider here relative bias and relative variance instead of raw bias and variance. Thus, anytime we mention the biases and variances in the results section, we refer to relative bias and variance.
\item
...
\leavevmode\vadjust pre{\hypertarget{ref-peng_beyond_2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wackerly_mathematical_2008}{}}%
