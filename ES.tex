...
\end{minipage} & \begin{minipage}[t]{0.52\columnwidth}\centering
\tiny\(\frac{(n_c-1) \times \left(\frac{1}{n_c}+\frac{\sigma^2_{exp}}{n_{exp} \times \sigma^2_c} \right)}{(n_c-3)} \times \left(1+\frac{\delta_{glass}^2}{\frac{1}{n_c}+\frac{\sigma^2_{exp}}{n_{exp} \times \sigma^2_c}}\right) -\delta_{glass}^2 \times \left[\frac{\sqrt{\frac{n_c-1}{2}} \times \Gamma(\frac{n_c-2}{2})}{\Gamma(\frac{n_c-1}{2})}\right]^2\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.06\columnwidth}\raggedright
\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\centering
