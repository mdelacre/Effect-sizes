...
```{r meandiffsampl,echo=FALSE}
#  Normal distribution
nSims=10000
meandiffsampl1<-function(SD){
  sd1=rep(0,nSims)
  sd2=rep(0,nSims)
  meandiff=rep(0,nSims)
...
meandiffsampl2<-function(SD){
  ...
  for (i in 1:nSims){
    ...
    n=20
    y1 <- rpearson(n,moments=c(m1=2,SD^2,skewness=skew*(n-2)/sqrt(n*(n-1)),kurtosis=(kurt*(n-2)*(n-3)-6*(n-1))/(n^2-1)+3))
    y2 <- rpearson(n,moments=c(m1=1,SD^2,skewness=skew*(n-2)/sqrt(n*(n-1)),kurtosis=(kurt*(n-2)*(n-3)-6*(n-1))/(n^2-1)+3))
...
rep1 <-  sapply(seq(1,10,1),meandiffsampl1) # normal
rep2 <-  sapply(seq(1,10,1),meandiffsampl2) # pas normal
rep3 <-  sapply(seq(1,10,1),meandiffsampl3)# right-skewed
rep4 <-  sapply(seq(1,10,1),meandiffsampl4)# left-skewed
```

```{r meandiffbis,fig.cap = "standard deviation of the sampling distribution of s, as a function of sigma, for difference distributions underlying the data",echo=FALSE}
par(mar=c(2,5,2,2))
...
plot(0,xlim=c(1,10), ylim=c(0,6),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X1),"-",bar(X2),")")))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep1,col="black")
points(seq(1,10,1),rep1,pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep2,col="orange")
points(seq(1,10,1),rep2,pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep3,col="blue")
points(seq(1,10,1),rep3,pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep4,col="green")
points(seq(1,10,1),rep4,pch=19,cex=.8,col="green")

plot(0,xlim=c(1,10), ylim=c(.3,.4),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X),"-",bar(X1),")/",sigma )))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep1/seq(1,10,1),col="black")
points(seq(1,10,1),rep1/seq(1,10,1),pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep2/seq(1,10,1),col="orange")
points(seq(1,10,1),rep2/seq(1,10,1),pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep3/seq(1,10,1),col="blue")
points(seq(1,10,1),rep3/seq(1,10,1),pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep4/seq(1,10,1),col="green")
points(seq(1,10,1),rep4/seq(1,10,1),pch=19,cex=.8,col="green")
```
...
rep5 <-  sapply(seq(1,10,1),sdsampl1) # normal
rep6 <-  sapply(seq(1,10,1),sdsampl2) # pas normal
rep7 <-  sapply(seq(1,10,1),sdsampl3)# right-skewed
rep8 <-  sapply(seq(1,10,1),sdsampl4)# left-skewed
```
...
plot(0,xlim=c(1,10), ylim=c(0,6),col="white",xlab=expression(sigma),ylab="sd(S)")
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep5[2,],col="black")
points(seq(1,10,1),rep5[2,],pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep6[2,],col="orange")
points(seq(1,10,1),rep6[2,],pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep7[2,],col="blue")
points(seq(1,10,1),rep7[2,],pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep8[2,],col="green")
points(seq(1,10,1),rep8[2,],pch=19,cex=.8,col="green")

plot(0,xlim=c(1,10), ylim=c(0,.7),col="white",xlab=expression(sigma),ylab=expression(paste("sd(S)/",sigma)))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep5[2,]/seq(1,10,1),col="black")
points(seq(1,10,1),rep5[2,]/seq(1,10,1),pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep6[2,]/seq(1,10,1),col="orange")
points(seq(1,10,1),rep6[2,]/seq(1,10,1),pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep7[2,]/seq(1,10,1),col="blue")
points(seq(1,10,1),rep7[2,]/seq(1,10,1),pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep8[2,]/seq(1,10,1),col="green")
points(seq(1,10,1),rep8[2,]/seq(1,10,1),pch=19,cex=.8,col="green")
```


```{r ratiosdmeandiffsampl,echo=FALSE}
#  Normal distribution
nSims=10000
ratiosampl1<-function(SD){
  ratiosd1=rep(0,nSims)
  ratiosd2=rep(0,nSims)
  ...
  for (i in 1:nSims){
    ...
    ratiosd1[i]=(mean(y1)-mean(y2))/sd(y1)
    ratiosd2[i]=(mean(y1)-mean(y2))/sd(y2)

  }
  
  return(c(sd(ratiosd1),sd(ratiosd2)))
  
}

#  Symmetric distribution with high kurtosis
ratiosampl2<-function(SD){
  ratiosd1=rep(0,nSims)
  ratiosd2=rep(0,nSims)
...
rep9 <-  sapply(seq(1,10,1),ratiosampl1) # normal
rep10 <-  sapply(seq(1,10,1),ratiosampl2) # pas normal
rep11 <-  sapply(seq(1,10,1),ratiosampl3)# right-skewed
rep12 <-  sapply(seq(1,10,1),ratiosampl4)# left-skewed
```

```{r ratiosamplbis,fig.cap = "standard deviation of the sampling distribution of s, as a function of sigma, for difference distributions underlying the data",echo=FALSE}
par(mar=c(2,5,2,2))
...
plot(0,xlim=c(1,10), ylim=c(0,6),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X1),"-",bar(X2),")")))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep9[1,],col="black")
points(seq(1,10,1),rep9[1,],pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep10[1,],col="orange")
points(seq(1,10,1),rep10[1,],pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep11[1,],col="blue")
points(seq(1,10,1),rep11[1,],pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep12[1,],col="green")
points(seq(1,10,1),rep12[1,],pch=19,cex=.8,col="green")

plot(0,xlim=c(1,10), ylim=c(0,2),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X),"-",bar(X1),")/",sigma )))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep9[1,]/seq(1,10,1),col="black")
points(seq(1,10,1),rep9[1,]/seq(1,10,1),pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep10[1,]/seq(1,10,1),col="orange")
points(seq(1,10,1),rep10[1,]/seq(1,10,1),pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep11[1,]/seq(1,10,1),col="blue")
points(seq(1,10,1),rep11[1,]/seq(1,10,1),pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep12[1,]/seq(1,10,1),col="green")
points(seq(1,10,1),rep12[1,]/seq(1,10,1),pch=19,cex=.8,col="green")

plot(0,xlim=c(1,10), ylim=c(0,2),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X),"-",bar(X1),")/",sigma )))
axis(1,at=1:10,labels=TRUE)
lines(seq(1,10,1),rep9[2,]/seq(1,10,1),col="black")
points(seq(1,10,1),rep9[2,]/seq(1,10,1),pch=19,cex=.8,col="black")
lines(seq(1,10,1),rep10[2,]/seq(1,10,1),col="orange")
points(seq(1,10,1),rep10[2,]/seq(1,10,1),pch=19,cex=.8,col="orange")
lines(seq(1,10,1),rep11[2,]/seq(1,10,1),col="blue")
points(seq(1,10,1),rep11[2,]/seq(1,10,1),pch=19,cex=.8,col="blue")
lines(seq(1,10,1),rep12[2,]/seq(1,10,1),col="green")
points(seq(1,10,1),rep12[2,]/seq(1,10,1),pch=19,cex=.8,col="green")
...
#  Symmetric distribution with less extreme kurtosis
meandiffsampl2<-function(SD){
  sd1=rep(0,nSims)
  sd2=rep(0,nSims)
  meandiff=rep(0,nSims)
  ...
  for (i in 1:nSims){
    ...
    n=20
    y1 <- rpearson(n,moments=c(m1=2,SD^2,skewness=skew*(n-2)/sqrt(n*(n-1)),kurtosis=(kurt*(n-2)*(n-3)-6*(n-1))/(n^2-1)+3))
    y2 <- rpearson(n,moments=c(m1=1,SD^2*2,skewness=skew*(n-2)/sqrt(n*(n-1)),kurtosis=(kurt*(n-2)*(n-3)-6*(n-1))/(n^2-1)+3))
...
rep13 <-  sapply(seq(1,10,1),meandiffsampl1) # normal
rep14 <-  sapply(seq(1,10,1),meandiffsampl2) # pas normal
rep15 <-  sapply(seq(1,10,1),meandiffsampl3)# right-skewed


rep16 <-  sapply(seq(1,10,1),meandiffsampl4)# left-skewed

```

```{r meandiff$ter,fig.cap = "standard deviation of the sampling distribution of s, as a function of sigma, for difference distributions underlying the data",echo=FALSE}
par(mar=c(2,5,2,2))
layout(matrix(c(1,1,1,2,3,4),nrow=2,byrow=TRUE))
plot(1,col="white",main="",bty="n",xaxt="n",yaxt="n",xlab="",ylab="")
legend("center",legend=c(expression(paste(gamma,1,"=0 and ",gamma,2,"=0")),expression(paste(gamma,1,"=0 and ",gamma,2,"=95.75")),expression(paste(gamma,1,"=6.32 and ",gamma,2,"=95.75")),expression(paste(gamma,1,"=-6.32 and ",gamma,2,"=95.75"))),col=c("black","orange","blue","green"),bty="n",lty=c(1,1,1,1))
...
plot(0,xlim=c(2,22), ylim=c(0,6),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X1),"-",bar(X2),")")))
axis(1,at=2:22,labels=TRUE)
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep13,col="black")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep13,pch=19,cex=.8,col="black")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep14,col="orange")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep14,pch=19,cex=.8,col="orange")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep15,col="blue")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep15,pch=19,cex=.8,col="blue")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep16,col="green")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep16,pch=19,cex=.8,col="green")

plot(0,xlim=c(2,22), ylim=c(0,2),col="white",xlab=expression(sigma),ylab=expression(paste("sd(",bar(X),"-",bar(X1),")/",sigma )))
axis(1,at=2:22,labels=TRUE)
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep13/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),col="black")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep13/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),pch=19,cex=.8,col="black")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep14/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),col="orange")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep14/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),pch=19,cex=.8,col="orange")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep15/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),col="blue")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep15/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),pch=19,cex=.8,col="blue")
lines(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep16/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),col="green")
points(sqrt(seq(1,10,1)^2+seq(2,20,2)^2),rep16/sqrt(seq(1,10,1)^2+seq(2,20,2)^2),pch=19,cex=.8,col="green")
